...
Ask your AI: **"Can you make HTTP requests?"** If yes, follow the Tier A instructions. If not, follow Tier B — or ask your AI to help you configure HTTP access to `https://suf-agent-2026-qa.vercel.app`.
...
API: [`https://suf-agent-2026-qa.vercel.app/api/`](https://suf-agent-2026-qa.vercel.app/api/health)
