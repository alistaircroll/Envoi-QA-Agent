...
Ask your AI: **"Can you make HTTP requests?"** If yes, follow the Tier A instructions. If not, follow Tier B — or ask your AI to help you configure HTTP access to `https://qa.envoiplatform.com`.
...
API: [`https://qa.envoiplatform.com/api/`](https://qa.envoiplatform.com/api/health)
